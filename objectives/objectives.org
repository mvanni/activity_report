...
**** Problem
ASR coponents like acousti models are not available for key languages and accented versions of major languages.
**** Research Question
...
I will obtain the source language resources from the GlobalPhone corpus.
* 2016-2017: 
** 1. TECHNICAL COMPETENCE
*** ASR Adaptation:

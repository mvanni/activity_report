...
Can we leverage the resources we have available to build acoustic models for a language for which we have very few resources?
I will use the kaldi multilang recipe to build acoustic models for one language given resources from many other languages. 
* 2016-2017: 1. TECHNICAL COMPETENCE
** ASR Adaptation:

...
I spent the day setting up English recipes.
1. vystadial_en
2. voxforge.
3. wsj

- Multilang: Librispeech gp_hausa:
MTL Training:
Librispeech: 960 hours English read.
Gp Hausa:  4.8 hours of read GlobalPhone Hausa
gp_hausa dev: 0.3 hours
gp_hausa test: 0.3 hours of hausa

test results:
%WER 15.16 [ 234 / 1544, 4 ins, 53 del, 177 sub ] exp/multi_gp_hausa_librispeech/gp_hausa/decode_test/wer_15_0.0

Dev results:
%WER 21.83 [ 365 / 1672, 17 ins, 57 del, 291 sub ] exp/multi_gp_hausa_librispeech/gp_hausa/decode_dev/wer_10_0.0
Previous Best:
A system was trained on 17 languages and the WER was 21.77.

** Goals for Next Week:
- TODO Car Talk Project: Get English recipes up and running.
- TODO WSJ: Setup recipe.
- TODO TIMIT: Setup recipe.
- TODO AMI: Setup recipe.
- TODO BN_Music_Speech: Setup Recipe
- TODO HUB4: Setup recipe.
- TODO Speaker Recognition Recipes: Set these up.
- TODO West Point English: Setup recipe.
- TODO Multilang TN: Take another pass on writing.
